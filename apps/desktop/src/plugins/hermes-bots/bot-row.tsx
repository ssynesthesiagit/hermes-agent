...
import { ensureBotMetadata, openBotCanonicalChatInWindow } from './canonical-chat'
import {
  $botAttention,
  $botMeta,
  $lastRoster,
  ...
  return (
    <ContextMenu>
      ...
      <ContextMenuContent>
        ...
        <ContextMenuItem onSelect={() => void openInWindow()}>Open Bot Chat in New Window</ContextMenuItem>
        <ContextMenuItem onSelect={() => void openSessions()}>Sessions</ContextMenuItem>
        <ContextMenuSeparator />
        <ContextMenuItem
          onSelect={() => {
